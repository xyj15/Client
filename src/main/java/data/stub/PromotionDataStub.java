...
public class PromotionDataStub implements PromotionDataService {
	...
	public PromotionDataStub() {
		...
		PromotionPO promotionPO5 = new PromotionPO("00004", "合作企业特惠", PromotionType.Discount, "123456");
		promotionPO5.setEnterprisePromotion("", 0.7, 0, 0);
		promotionList.add(promotionPO5);
		PromotionPO promotionPO6 = new PromotionPO("00005", "双十一特惠", PromotionType.Discount, "123456");
