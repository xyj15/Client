...
public interface RoomDataService extends java.rmi.Remote {
	
	public RoomPO getSingleRoom(Date date, String roomNum, String hotelID) throws RemoteException;  //得到具体某间房的信息
	public boolean addSingleRoom(RoomPO room, String hotelID) throws RemoteException;  //添加具体房间
	public boolean updateSingleRoom(Date date, RoomPO room, String hotelID) throws RemoteException;  //更新具体房间信息
